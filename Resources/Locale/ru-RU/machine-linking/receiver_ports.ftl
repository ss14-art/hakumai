...
signal-port-name-direct-drive = Прямой привод
signal-port-description-direct-drive = Переключает шлюз на прямое управление сигналами. ВЫСОКИЙ уровень — открыть, НИЗКИЙ — закрыть.
