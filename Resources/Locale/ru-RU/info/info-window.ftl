...
ui-info-header-intro-persist = Порог
ui-info-header-intro-persist-basics = Основы
ui-info-header-intro-persist-ins-outs = Входы и выходы
ui-info-header-intro-persist-independence-interdependence = Независимость и взаимозависимость
