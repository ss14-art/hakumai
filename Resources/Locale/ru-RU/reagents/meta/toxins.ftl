...
reagent-name-phoron = форон
reagent-desc-phoron = Радиоактивное инопланетное соединение с экстраординарными свойствами. Крайне токсично и высоко ценится.
...
reagent-name-tartaric-acid = винная кислота
reagent-desc-tartaric-acid = Кислота, часто встречающаяся в некоторых фруктах, например в винограде.
