...
ent-ClothingHeadHatBeretSecurityBlack = чёрный берет охраны
    .desc = Берет с эмблемой службы безопасности. Для офицеров, которые больше ценят стиль, чем безопасность.
ent-ClothingHeadHatBeretSecurityDarkBlue = тёмно-синий берет охраны
    .desc = Берет с эмблемой службы безопасности. Для офицеров, которые больше ценят стиль, чем безопасность.
ent-ClothingHeadHatBeretSecurityDarkRed = тёмно-красный берет охраны
    .desc = Берет с эмблемой службы безопасности. Для офицеров, которые больше ценят стиль, чем безопасность.
ent-ClothingHeadHatBeretSecurityLightBlue = светло-синий берет охраны
    .desc = Берет с эмблемой службы безопасности. Для офицеров, которые больше ценят стиль, чем безопасность.
ent-ClothingHeadHatBeretSecurityLightRed = светло-красный берет охраны
    .desc = Берет с эмблемой службы безопасности. Для офицеров, которые больше ценят стиль, чем безопасность.
