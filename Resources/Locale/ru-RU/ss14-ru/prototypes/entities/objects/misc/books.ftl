...
ent-BookLeafLoversSecret = Секрет листолюба
    ...
    .suffix = { ent-BaseGuidebook.suffix }
ent-BookThresholdHandbook = Руководство по выживанию в Пограничье
    .desc = Справочник о том, как выживать и процветать в Пограничье.
    .suffix = { ent-BaseGuidebook.suffix }
ent-BookFactionHandbook = Справочник по фракциям
    .desc = Справочник о фракциях в Пограничье.
    .suffix = { ent-BaseGuidebook.suffix }
...
ent-BookHowToRockAndStone = Пособие по камням и скалам
    ...
    .suffix = { ent-BaseGuidebook.suffix }
ent-BookGasMining = Добыча газа для чайников
    .desc = Руководство для опытных шахтёров, которые хотят заняться добычей газа.
    .suffix = { ent-BaseGuidebook.suffix }
