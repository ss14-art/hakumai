...
ent-JobNetworkImplant = имплант трудовой сети
    .desc = Этот имплант позволяет пользователю подключаться к местной трудовой сети для начала и окончания рабочей смены.
