...
ent-WeaponRifleCiggyLauncher = тактический заправщик сигарет
    .desc = Агрессивная маркетинговая стратегия.
...
ent-WeaponRifleVulcan = Вулкан
    .desc = Одно из самых тяжёлых образцов стрелкового оружия, украшающих арсенал Службы Безопасности. Эта винтовка представляет собой современный взгляд на классическую FAL, неофициально прозванную «Правой рукой свободного мира». Использует патроны калибра .30 винтовочный.
ent-WeaponRifleM90NoGL = M-90
    .desc = Карабин более старой модели, выполненный по схеме булл-пап. Использует патроны калибра .20 винтовочный.
