...
ent-GridControlComputerCircuitboard = консоль управления сеткой (консольная плата)
    .desc = Консольная плата для консоли управления сеткой.
ent-MessageBoardCircuitboard = доска объявлений (консольная плата)
    .desc = Консольная плата для консоли доски объявлений.
ent-StationModComputerCircuitboard = консоль модификации фракции (консольная плата)
    .desc = Консольная плата для консоли модификации фракции.
ent-IdPrinterCircuitboard = принтер ID-карт (консольная плата)
    .desc = Консольная плата для консоли принтера ID-карт.
ent-InvoicePrinterCircuitboard = принтер счетов (консольная плата)
    .desc = Консольная плата для консоли принтера счетов.
