...
ent-MethaneCanister = канистра метана
    .desc = Канистра, заполненная метаном. Её можно прикрепить к порту коннектора с помощью гаечного ключа.
ent-HydrogenCanister = канистра водорода
    .desc = Канистра, заполненная водородом. Её можно прикрепить к порту коннектора с помощью гаечного ключа.
ent-FluorineCanister = канистра фтора
    .desc = Канистра, заполненная фтором. Её можно прикрепить к порту коннектора с помощью гаечного ключа.
ent-ChlorineCanister = канистра хлора
    .desc = Канистра, заполненная хлором. Её можно прикрепить к порту коннектора с помощью гаечного ключа.
ent-ChlorineTrifluorideCanister = канистра трифторида хлора
    .desc = Канистра, заполненная трифторидом хлора (ClF3). Обращайтесь с крайней осторожностью.
...
ent-ChlorineTrifluorideCanisterBroken = { ent-GasCanisterBrokenBase }
    .desc = { ent-GasCanisterBrokenBase.desc }
ent-MaxCapCanister = макс кап в банке
    .desc = { ent-GasCanister.desc }
    .suffix = ДЕБАГ, Макс Кап
