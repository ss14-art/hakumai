...
ent-PortableGeneratorOldman = портативный генератор С.Т.А.Р.И.К.
    .desc = Угольный генератор с увеличенным временем работы по сравнению с большинством аналогов. Остерегайтесь выхлопных газов!
    .suffix = Уголь, 15 кВт
ent-PortableGeneratorMegaman = портативный генератор М.Е.Г.А.М.Е.Н.
    .desc = Передовой генератор для экстремальных потребностей в энергии.
        Работает на экзотических листах форона и рассчитан на мощность до 75 кВт.
        ВНИМАНИЕ: Значительно более высокий расход топлива. Используйте только при необходимости.
    .suffix = Форон, 75 кВт
